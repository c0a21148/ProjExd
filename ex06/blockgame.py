...
def main():
    ...
    Ball.paddle_sound = pygame.mixer.Sound(
        "C:\Users\81808\Documents\ProjExD2022\fig/flashing.wav")    # パドルにボールが衝突した時の効果音取得
    Ball.block_sound = pygame.mixer.Sound(
        "C:\Users\81808\Documents\ProjExD2022\fig\flying_pan.wav")    # ブロックにボールが衝突した時の効果音取得
    Ball.gameover_sound = pygame.mixer.Sound(
        "C:\Users\81808\Documents\ProjExD2022\fig/fig/badend1.wav")    # ゲームオーバー時の効果音取得
    # 描画用のスプライトグループ
